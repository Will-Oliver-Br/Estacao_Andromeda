...
namespace Content.Client.VendingMachines.UI
{
    ...
    public sealed partial class VendingMachineMenu : FancyWindow
    {
        ...
        private readonly StyleBoxFlat _styleBox = new() { BackgroundColor = new Color(70, 73, 102, 50) }; //ADT-Economy
        ...
        {
            if (data is not VendorItemsListData { ItemProtoID: var protoID, ItemText: var text, Entry: var entry }) //ADT-Economy
                return;
            ...
            else
            {
                for (var i = 0; i < entry.Amount; i++)
                {
                    ...
                    item.Count.AddItem($"{amount} Item" + priceStr, i);
                }
            }
            item.Count.Select(0);
        ...
        /// </summary>
        public void Populate(EntityUid entityUid, List<VendingMachineInventoryEntry> inventory, double priceMultiplier, int credits) //ADT-Economy
        {
            //ADT-Economy-Start
