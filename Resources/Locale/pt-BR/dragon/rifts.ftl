...
carp-rift-proximity = Perto demais de uma fenda! Precisa estar a pelo menos {$proximity}m de distancia.
carp-rift-space-proximity = Perto demais do espaço! Precisa estar a pelo menos {$proximity}m de distancia.
carp-rift-weakened = Você está incapaz de invocar mais fendas em seu estado enfraquecido.
