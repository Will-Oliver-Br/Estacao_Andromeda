guide-entry-setting-lore = Configuração de Lore
guide-entry-corporations = Corporações
...
guide-entry-nations = Nações
guide-entry-sol-alliance = Aliança Solariana
guide-entry-tcfl = Legião Estrangeira de Tau-Ceti
